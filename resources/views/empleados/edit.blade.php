                ...
                <form action="{{ route('empleados.update', $empleado) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_ingreso" value="{{ old('fecha_ingreso', $empleado->fecha_ingreso ? $empleado->fecha_ingreso->format('Y-m-d') : '') }}" required class="w-full rounded-xl border-slate-300 focus:border-cyan-500 focus:ring-cyan-500">
